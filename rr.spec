...
Source0  : https://github.com/mozilla/rr/archive/5.3.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584223260
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/rr-5.3.0/LICENSE %{buildroot}/usr/share/package-licenses/rr/59884174935f26db20d5296805313b52834752e4
pushd clr-build
%make_install
popd
