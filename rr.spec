...
Version  : 5.6.0
Release  : 15
URL      : https://github.com/mozilla/rr/archive/5.6.0/rr-5.6.0.tar.gz
Source0  : https://github.com/mozilla/rr/archive/5.6.0/rr-5.6.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672199720
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/rr-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/rr/59884174935f26db20d5296805313b52834752e4
pushd clr-build
%make_install
popd
