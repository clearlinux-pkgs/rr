...
Version  : 5.5.0
Release  : 14
URL      : https://github.com/mozilla/rr/archive/5.5.0/rr-5.5.0.tar.gz
Source0  : https://github.com/mozilla/rr/archive/5.5.0/rr-5.5.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632252227
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/rr-5.5.0/LICENSE %{buildroot}/usr/share/package-licenses/rr/59884174935f26db20d5296805313b52834752e4
pushd clr-build
%make_install
popd
